...
object SensorService {
    ...
    fun getLocationsWithLatestMeasurements(timezone: String): App<Error, List<LocationWithLatestMeasurementsDTO>> =
        KIO.comprehension {
            val latestMeasurements = !SensorRepo.fetchLocationsWithLatestMeasurements(timezone, "metric").orDie()
    ...
    fun getLocationsWithLatestMeasurementsNEW(
        ...
        KIO.comprehension {
            ...
            val rawLocations = !SensorRepo.fetchLocationsWithLatestMeasurements(clientTimeZone, units).orDie()
                .onNullFail { Error.NotFound }
            KIO.ok(rawLocations.map { it.toLocationWithBoxesDTO() })
        }
    ...
    fun getLocationByIDWithMeasurementsWithinTimespan(
        ...
        KIO.ok(rawLocation.toLocationWithBoxesDTO())
    }
